/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a7f26afb910cf336b141f4b0838cc32)
// Runtime types generated with workerd@1.20260611.1 2026-06-16 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	LIVE_DEV_OPEN: string;
	...
	AUTHORIZED_VIEWER_EMAIL: string;
	OPENAI_API_KEY: string;
	SUPABASE_URL: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	LABBOOK_ADMIN_PASSWORD: string;
	LIVE_ROOM: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").LiveRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIVE_DEV_OPEN" | "BROADCASTER_TOKEN" | "LIVE_TITLE" | "STUN_URLS" | "FORCE_TURN" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "AUTHORIZED_VIEWER_EMAIL" | "OPENAI_API_KEY" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "LABBOOK_ADMIN_PASSWORD">> {}
}
